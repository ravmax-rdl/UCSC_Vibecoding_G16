...
1. **"Write a Python script that asks for a student's name, asks for 3 subject marks, calculates the average, and displays 'Pass' if the average is greater than or equal to 40, else 'Fail'."**  
...
2. **"Assign Grade A for average ≥ 75, Grade B for 60–74, Grade C for 40–59, Fail below 40."**  
...
3. **"Modify the program so it runs repeatedly until the user types 'exit'."**  
...
4. **"Write a Python script that asks the user for a total monthly budget, asks for 3 expenses, subtracts expenses from the total budget, and displays the remaining balance."**  
...
5. **"The marks for the grade calculator should only be valid if between 0 and 100."**  
...
6. **"Add validation to the budget tracker as well, for the input values to be greater than 0."**  
